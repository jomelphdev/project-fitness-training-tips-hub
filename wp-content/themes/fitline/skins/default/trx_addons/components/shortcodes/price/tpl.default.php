			...
			?><div class="sc_price_item_info"><?php
				...
				if (!empty($item['price'])) {
					...
					?><div class="sc_price_item_price"><?php
						...
						?><span class="sc_price_item_price_value"><?php echo wp_kses($parts[0], 'trx_addons_kses_content'); ?></span><?php
						if (count($parts) > 1 && $parts[1]!='') {
							?><span class="sc_price_item_price_decimals"><?php echo wp_kses($parts[1], 'trx_addons_kses_content'); ?></span><?php
						}
