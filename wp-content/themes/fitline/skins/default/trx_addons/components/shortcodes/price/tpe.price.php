...
#><div id="{{ id }}" class="<# print( trx_addons_apply_filters('trx_addons_filter_sc_classes', 'sc_price sc_price_' + settings.type, settings ) ); #>">
	...
	_.each(settings.prices, function(item) {
		...
		#><div class="sc_price_item sc_price_item_<#
			print(settings.type);
			if(item.price_active == 'yes') print(' sc_price_active ');
		...
		#>><#
			...
			if (item.image.url != '') {
				#><div class="sc_price_item_image"><img src="{{ item.image.url }}" alt="<?php esc_attr_e('Icon', 'fitline'); ?>"></div><#
			} else {
...
else if(settings.type == 'light' || settings.type == 'simple' || settings.type == 'simple_shadow' || settings.type == 'plain' || settings.type == 'focus' || settings.type == 'metro' ) {
	if(settings.type != 'metro') {
	var link_class = "<?php echo apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_price_item_link sc_button sc_button_bordered', 'sc_price'); ?>";
	}
	#>
	<div id="{{ id }}" class="<# print( trx_addons_apply_filters('trx_addons_filter_sc_classes', 'sc_price sc_price_' + settings.type, settings ) ); #>">
				...
				#>"<#
						...
						#><div class="sc_price_item_info"><#
							...
							if (item.price != '') {
								...
								#><span class="sc_price_item_price_value">{{ item.price }}</span><#
								if (item.after_price !='') {
								#><span class="sc_price_item_price_after"><# print(trx_addons_parse_codes(item.after_price)); #></span><#
								}
								#></div><#
							...
							if (settings.type != 'metro' && item.link.url != '' && item.link_text != '') {
							#><a href="{{ item.link.url }}" class="{{ link_class }}">{{ item.link_text }}</a><#
							}
							#></div><!-- /.sc_price_item_info --><#
						#></div><!-- /.sc_price_item_inner --><#
