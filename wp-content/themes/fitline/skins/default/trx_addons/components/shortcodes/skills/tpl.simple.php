<?php
/**
 * The style "simple" of the Skills
 *
				...
				. '<div class="sc_skills_item">'
					...
					. ( ! empty( $v['image'] )
						? '<div class="sc_skills_image">'
							. '<img src="' . esc_url( $v['image'] ) . '" alt="' . esc_attr__('Icon', 'fitline') . '"'
					...
					. ( ! empty( $icon ) && ! trx_addons_is_off( $icon )
						? '<div class="sc_skills_icon sc_icon_type_' . esc_attr($v['icon_type']) . ' ' . esc_attr($icon) . esc_attr($icon_color_class) . '">'
								. ( ! empty($svg)
									...
									: '')
								. ( ! empty($img)
									? '<img class="sc_icon_as_image" src="'.esc_url($img).'" alt="'.esc_attr__('Icon', 'fitline').'">'
									: '')
								. '</div>'
						: ''
						)
...
?><div<?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'" '; ?>
		class="sc_skills sc_skills_counter_simple sc_skills_counter_style_<?php
            ...
            echo (!trx_addons_is_off($args['show_divider']) ? ' with_divider' : '');
		?>"
