								...
								apply_filters( 'trx_addons_filter_args_featured', array(
											...
											'post_info' => apply_filters('trx_addons_filter_post_info',
																	'<div class="trx_addons_hover_team">'
																		...
																		. '</div>') : '')
																		. (!empty($meta["socials"][0]["name"]) ? '<div class="sc_team_item_socials socials_wrap trx_addons_hover_info">' . trim(trx_addons_get_socials_links_custom($meta['socials'], '', 'names')) . '</div>' : '')
																	. '</div>'
																	. ( true
