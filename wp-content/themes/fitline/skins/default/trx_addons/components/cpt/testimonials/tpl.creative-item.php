<?php
/**
 * The style "creative" of the Testimonials
 *
...
<div data-post-id="<?php the_ID(); ?>" class="sc_testimonials_item sc_item_container post_container">
	...
	<div class="sc_testimonials_item_top">
		...
		<div class="sc_testimonials_item_author_avatar"><?php the_post_thumbnail( fitline_get_thumb_size('tiny'), array('alt' => get_the_title()) ); ?></div>
		<?php } ?>
	</div>
