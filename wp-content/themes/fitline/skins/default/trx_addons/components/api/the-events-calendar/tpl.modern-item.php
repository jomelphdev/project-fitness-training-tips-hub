<?php
/**
 * The style "modern" of the Events
 *
...
<div class="sc_events_item sc_item_container post_container">
	...
	if (has_post_thumbnail()) {
		...
		trx_addons_get_template_part('templates/tpl.featured.php',
									...
									apply_filters('trx_addons_filter_args_featured', array(
                                                        ...
                                                        'thumb_bg' => true,
                                                        'thumb_size' => apply_filters('trx_addons_filter_thumb_size', fitline_get_thumb_size('masonry-big'), 'events-'.$args['type'], $args)
	...
	<div class="sc_events_item_info">
		<div class="sc_events_item_header"><?php
            if ($cost !== '') { ?>
