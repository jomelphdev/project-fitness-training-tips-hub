...
// Attention! Parameter 'suppress_filters' is damage WPML-queries!
    ...
    // Add new portfolio related item
    if( isset( $trx_addons_args['post_type']) && 'cpt_portfolio' == $trx_addons_args['post_type'] ) {
        $trx_addons_args['template'] = TRX_ADDONS_PLUGIN_CPT . 'portfolio/tpl.simple-item.php';
        $trx_addons_args['class'] = 'portfolio_page_related sc_portfolio sc_portfolio_simple';
    }
