...
if ($trx_addons_show_image) {
	...
	if ($trx_addons_post_thumb)
		$trx_addons_output .= '<div class="post_thumb hover_zoom">'
...
$trx_addons_output .= '<div class="post_content">'
			. ((!empty($trx_addons_post_categories_output) || $trx_addons_show_date || $trx_addons_show_author || $trx_addons_post_counters_output) ?
				'<div class="post_info">'
					. ( !empty($trx_addons_post_categories_output)
						? '<div class="post_info_item post_categories">'
