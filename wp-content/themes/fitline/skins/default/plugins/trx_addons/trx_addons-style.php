...
if ( ! function_exists( 'fitline_trx_addons_get_css' ) ) {
	add_filter( 'fitline_filter_get_css', 'fitline_trx_addons_get_css', 10, 2 );
	function fitline_trx_addons_get_css( $css, $args ) {
...
.sc_blogger_default.sc_blogger_default_courses .sc_blogger_item_course_meta .course_meta_item,
.sc_blogger_default.sc_blogger_default_courses .sc_blogger_item:not(.sc_blogger_item_with_image) .sc_blogger_item_course_price,
...
.sc_blogger_default.sc_blogger_default_courses .post_meta_item.post_author,
