...
if ( ! function_exists( 'fitline_gutenberg_get_css' ) ) {
	add_filter( 'fitline_filter_get_css', 'fitline_gutenberg_get_css', 10, 2 );
	function fitline_gutenberg_get_css( $css, $args ) {
