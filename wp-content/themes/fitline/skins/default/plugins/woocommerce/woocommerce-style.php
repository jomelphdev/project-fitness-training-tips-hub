...
if ( ! function_exists( 'fitline_woocommerce_get_css' ) ) {
	add_filter( 'fitline_filter_get_css', 'fitline_woocommerce_get_css', 10, 2 );
	function fitline_woocommerce_get_css( $css, $args ) {
...
$fdir = fitline_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
