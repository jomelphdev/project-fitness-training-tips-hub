...
if ( ! function_exists( 'fitline_tribe_events_get_css' ) ) {
	add_filter( 'fitline_filter_get_css', 'fitline_tribe_events_get_css', 10, 2 );
	function fitline_tribe_events_get_css( $css, $args ) {
