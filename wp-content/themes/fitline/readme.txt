== FitLine ==
Version: 1.0.0
Copyright: 2024, AxiomThemes
WordPress version: required at least 5.0, tested up to 6.4.3
...
Please install and activate it before starting to use the theme FitLine.
...
Theme documentation is available on https://fitline.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in FitLine is Fontello.
