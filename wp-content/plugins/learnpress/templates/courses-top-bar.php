...
<div class="lp-courses-bar test-here <?php echo esc_attr( $active ); ?>">
	<form class="search-courses" method="get" action="<?php echo esc_url_raw( learn_press_get_page_link( 'courses' ) ); ?>">
		...
		<input type="text" placeholder="<?php esc_attr_e( 'Search videos...', 'learnpress' ); ?>" name="c_search" value="<?php echo esc_attr( $s ); ?>">
